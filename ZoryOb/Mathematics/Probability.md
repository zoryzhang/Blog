...
###### Another zero-one law
Thm. For i.i.d. sequence of r.v.s. $X_{n}$, $\text{I\kern-0.15em P}(\lim_{n \to \infty} \frac{S_{n}}{n} \text{ exists} )$ is either 0 or 1.
...
## 7.6 Strong LLN
Motiv. In WLLN, the condition is i.i.d. sequence $\{X_{n}\}$ that $\text{I\kern-0.15em E}|X_{i}|<\infty$, $\mu:=\text{I\kern-0.15em E}X_{i}$, and the result is $\frac{S_{n}}{n}  \overset{\text{I\kern-0.15em P}}{\to} \mu$. But what's the necessary condition?
...
1. $\frac{S_{n}}{n}   \overset{a.s.}{\to} \mu$ for some $\mu$, iff $\text{I\kern-0.15em E}|X_{i}|<\infty$.
